// generated on 2017-05-26 using generator-webapp 3.0.0
...
gulp.task('lint', () => {
  return lint(['app/scripts/**/*.js', '!app/scripts/ptypo/*.js'])
...
gulp.task('fonts', () => {
  return gulp.src(require('main-bower-files')('**/*.{eot,svg,ttf,woff,woff2,otf,json}', function (err) {})
    .concat('app/fonts/**/*'))
